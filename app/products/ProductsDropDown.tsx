...
import ViewVariantsDialog from "@/app/AppTable/ProductDialog/ViewVariantsDialog";
...
export default function ProductsDropDown({ row }: ProductsDropDownProps) {
  ...
  const [showVariantsDialog, setShowVariantsDialog] = useState(false); // Variants dialog state
    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          <DropdownMenuItem onClick={() => setShowVariantsDialog(true)}>
      ...
      {/* Variants Dialog */}
      <ViewVariantsDialog
        isOpen={showVariantsDialog}
        onClose={() => setShowVariantsDialog(false)}
