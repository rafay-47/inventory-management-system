import { Category, Product, Supplier, Warehouse } from "@/app/types";
...
interface ProductState {
  ...
  editWarehouse: (warehouseId: string, updatedWarehouse: Partial<Warehouse>) => void;
...
export const useProductStore = create<ProductState>((set) => ({
  ...
  loadWarehouses: async () => {
    try {
      ...
      if (process.env.NODE_ENV === "development") {
        console.log("Warehouses loaded successfully:", response.data);
      }
    } catch (error) {
  ...
  editWarehouse: (warehouseId: string, updatedWarehouse: Partial<Warehouse>) =>
    set((state) => ({
